...
namespace prjRentalManagement.Controllers
{
    public class OwnerController : Controller
    {
        ...
        // GET: Owner — manager: all owners; owner: own record only
        public ActionResult Index()
        {
            ...
            {
                var oid = (int)Session["owner"];
                return View(db.owners.Where(o => o.ownerId == oid).ToList());
            }
        ...
        public ActionResult Details(int? id)
        {
            if (Session["manager"] == null && Session["owner"] == null)
                return RedirectToAction("Login", "OwnerAccess");
            if (id == null)
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            if (Session["owner"] != null && (int)Session["owner"] != id)
        ...
        // GET: Owner/Create — managers only (admin) add new owners
        public ActionResult Create()
        {
            if (Session["manager"] == null)
                return RedirectToAction("Register", "OwnerAccess");
            return View();
        }
